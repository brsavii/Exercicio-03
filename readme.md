...
b. Preencha os campos da tabela abaixo para a exclusão do elemento cujo valor
do seu índice é 0;
i valores [i]
Refaça o desenho do vetor após a remoção do elemento descrito no item b.
